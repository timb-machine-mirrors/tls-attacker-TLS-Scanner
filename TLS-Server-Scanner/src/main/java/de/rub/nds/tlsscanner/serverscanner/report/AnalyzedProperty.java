...
public enum AnalyzedProperty {
    ...
    VULNERABLE_TO_STARTTLS_INJECTION_ATTACK(AnalyzedPropertyCategory.ATTACKS),
    VULNERABLE_TO_STARTTLS_SESSION_FIXATION(AnalyzedPropertyCategory.ATTACKS),
    ...
    ALLOWS_PLAIN_LOGIN(AnalyzedPropertyCategory.STARTTLS);
